/** 
 * @Author       : pengwei.shi
 * @Date         : 2023-06-11 12:10:46
 * @LastEditors  : pengwei.shi
 * @LastEditTime : 2023-06-11 12:40:35
 * @FilePath     : \archero\assets\migrate-canvas.ts
 * @Description  : 
 */
/**
...
import { BaseNode, Camera, Canvas, Director, Node, director, game } from 'cc';
...
function getCanvasCameraLayer(node: Node): number | null {
    let layer = null;
